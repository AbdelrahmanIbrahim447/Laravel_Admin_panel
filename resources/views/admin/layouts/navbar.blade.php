...
<aside class="main-sidebar">
  ...
  <li class="treeview {{ active_menu('country')[0] }}">
    <a href="#">
    ...
    <ul class="treeview-menu" style="{{ active_menu('country')[1] }}">
      <li class=""><a href="{{ aurl('countries') }}"><i class="fa fa-flag"></i> {{ trans('admin.country') }}</a></li>
  ...
  <li class="treeview {{ active_menu('states')[0] }}">
   ...
   <li class="treeview style="{{ active_menu('departments')[0] }}">
    <a href="#">
   ...
   <li class="treeview style="{{ active_menu('trademarks')[0] }}">
    <a href="#">
    ...
    <ul class="treeview-menu" style="{{ active_menu('trademarks')[1] }}">
      ...
      <li class="treeview style="{{ active_menu('manufacturers')[0] }}">
    <a href="#">
      <i class="fa fa-gear"></i> <span>{{ trans('admin.manufacturers') }}</span>
      <span class="pull-right-container">
        
      </span>
    </a>
    <ul class="treeview-menu" style="{{ active_menu('manufacturers')[1] }}">
        <li class=""><a href="{{ aurl('manufacturers') }}"><i class="fa fa-gear"></i> {{ trans('admin.manufacturers') }}</a></li>
