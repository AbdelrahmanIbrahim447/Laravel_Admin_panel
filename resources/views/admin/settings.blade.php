...
<div class="">
	<div class="box-body">
		...
		<div class="form-group">
			{!! Form::label('sitemname_ar',trans('admin.sitename_ar')) !!}
			{!! Form::text('sitename_ar',setting()->sitename_ar,['class'=>'form-control']) !!}
		</div>
		<div class="form-group">
			{!! Form::label('sitemname_en',trans('admin.sitename_en')) !!}
		...
		<div class="form-group">
			{!! Form::label('message_maintence',trans('admin.message_maintence')) !!}
			{!! Form::textarea('message_maintence',setting()->message_maintence,['class'=>'form-control']) !!}
		</div>
